...
module.exports = function (argv) {
    ...
    commander_1.default
        ...
        .option('--no-dependencies', 'Disable dependency detection via npm or yarn')
        .action((version, { out, target, message, gitTagVersion, updatePackageJson, githubBranch, gitlabBranch, rewriteRelativeLinks, baseContentUrl, baseImagesUrl, yarn, ignoreFile, gitHubIssueLinking, gitLabIssueLinking, dependencies, }) => main((0, package_1.packageCommand)({
        packagePath: out,
        version,
        target,
    ...
    commander_1.default
        ...
        .option('--ignoreFile <path>', 'Indicate alternative .vscodeignore')
        .option('--no-dependencies', 'Disable dependency detection via npm or yarn')
        .action((version, { pat, target, message, gitTagVersion, updatePackageJson, packagePath, githubBranch, gitlabBranch, baseContentUrl, baseImagesUrl, yarn, noVerify, ignoreFile, dependencies, }) => main((0, publish_1.publish)({
        pat,
        version,
        targets: target,
        commitMessage: message,
